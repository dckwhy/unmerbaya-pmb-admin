              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5>Update Home</h5> 
                    <a href="<?php echo base_url('admin/home/add') ?>" class="btn shadow-2 btn-success pull-right">Add</a>
                    <a href="<?php echo base_url('admin/home/data') ?>" class="btn shadow-2 btn-primary pull-right">Data</a> 
                  </div>
                  <?php 
                  $id = $this->uri->segment(4);
                  $this->db->where('id', $id);
                  $row = $this->db->get('data_home')->row();
                  ?>
                  <form  id="input_data">
                    <div class="card-block"> 
                      <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          ...
                          <?php
                          if(@$row->banner){
                            $src = base_url('prabotan/image/home/'.@$row->banner);
                          } else {
                            $src = '#';
                          }
                          ?>
                          <img src="<?= base_url('prabotan/image/home/'.@$row->banner) ?>" alt="" id="preview" style="width:60%; margin:20px auto;">
                          <br><br>
                        </div>
                        <input type="hidden" name="id" value="<?= @$row->id ?>">
                        <input type="hidden" name="banner" value="<?php echo @$row->banner ?>">
                        <div class="col-md-12 col-sm-12 col-xs-12">
...
<script type="text/javascript">
 $(document).ready(function () {
   ...
   $('#input_data').on('submit', function (e) {
    ...
    $.ajax({
     type: "post",
     url: "<?php echo base_url('admin/home/edit_data') ?>",
     cache: false,
