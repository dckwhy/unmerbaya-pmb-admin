<section class="pcoded-main-container">
                                    ...
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table id="zero-configuration"
                                                ...
                                                <tbody>
                                                    <?php
                                                    $get_data_syarat = $this->db->get('unmer_core.data_jadwal_test')->result();
    ...
    <script>
        function get_detail(id) {
            window.location = ('<?= base_url() ?>admin/jadwal_tes/detail/' + id)
        }

        function get_edit(id) {
            window.location = ('<?= base_url() ?>admin/jadwal_tes/edit/' + id)
        }
    ...
    <script>
        ...
        function act_delete(id) {
            where_value = id;
            where_field = 'id';
            table_name = 'data_jadwal_test';
            $('.loading').show();
            $.ajax({
                type: "post",
                url: "<?php echo base_url('admin/Jadwal_tes/delete_data') ?>",
                cache: false,
                data: {
